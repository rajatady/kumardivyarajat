...
The architecture is `[2, N, 64, 1]` - two inputs, a variable-width first hidden layer, a fixed 64-wide second hidden layer, one linear output. I sweep the first layer width across eight values: 63, 64, 65, 80, 96, 105, 110, 128.
...
<Code src="fma_model.py" title="fma_model.py" collapsed />

The systematic investigation - 20-seed sensitivity analysis, width sweep, random sequence tracing:

<Code src="fma_investigation.py" title="fma_investigation.py" collapsed />

---

## References

<a id="ref-1"></a>1. Frankle, J. & Carlin, M. (2019). The lottery ticket hypothesis: Finding sparse, trainable neural networks. [arXiv:1803.03635](https://arxiv.org/abs/1803.03635)
