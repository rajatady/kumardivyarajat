...
And notice: 10% subspace beats 100% dense. A model that can only move in the directions that training always finds outperforms a fully unconstrained model. Less is more, if you know where to look. And all four seeds know the same "where."

<Emphasis>10% subspace beats 100% dense. Less is more, if you know where to look. And all four seeds know the same "where."</Emphasis>
...
All code is available at [repo link]. All raw results including the failures are in the results log.
